...
<?php $__env->startSection('statistic_content'); ?>
    <div class="card  p-5 shadow p-3 mb-5 bg-white rounded">
        <div class="card-title">
            <h2 class="create_staff_form text-bold"><?php echo e(__('Merged Reports')); ?></h2>
            ...
            <table id="mergedReports" class="table table-hover table-bordered text-center">
                <thead>
                    <tr class="table-primary">
                        ...
                        <th><?php echo e(__('Merged Report(s)')); ?></th>
                ...
                <tbody class="table-light">
                    <?php $__currentLoopData = $eventObject->mergedReports(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <?php if($locale == 'en'): ?>
                                <td class=<?php echo e($event->event_status_id == 4 ? 'bg-info' : 'bg-danger'); ?>>
                                    <?php if($event->event_status_id == 4): ?>
                                        Merged
                                    <?php endif; ?>
                                </td>
                            <?php elseif($locale == 'tr'): ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Tolgahan\Desktop\Tolga\OKUL\YEAR 4\SEMESTER 8\CMSE406\public-emergency-system\resources\views/report_operations/mergedReports.blade.php ENDPATH**/ ?>