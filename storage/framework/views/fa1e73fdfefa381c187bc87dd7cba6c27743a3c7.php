            ...
            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                <div class="card p-5 shadow p-3 mb-5 bg-white rounded">
                    <div class="card-title mt-3">
                        <h3 class="text-bold create_staff_form"><?php echo e(__('Create Agent')); ?></h3>
                        <hr class="create_staff_form">
                    </div>
                    <div class="card-body">
                        <form class="validatedForm" action="<?php echo e(route('createAgents')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="row gutters">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="fullName"><i class="far fa-id-card"></i> <?php echo e(__('Last Name')); ?></label>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="staff_role_id"><i class="fas fa-user-tag"></i>
                                            <?php echo e(__('Staff Role')); ?></label>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="department_id"><i class="far fa-building"></i> <?php echo e(__('Department')); ?>

                                        </label>
                                        <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example"
                                            name="department_id">
                                            <option value="" selected>-</option>
                                            <?php $__currentLoopData = $departmentTypeObject->departments(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $departmentType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value=<?php echo e($departmentType->id); ?>

                                                    <?php echo e($departmentType->title == $departmentType->id ? 'selected' : ''); ?>>
                                                    <?php echo e(Str::title($departmentType->title) . ' Department'); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Tolgahan\Desktop\Tolga\OKUL\YEAR 4\SEMESTER 8\CMSE406\public-emergency-system\resources\views/role_operations/agent_operations/createAgents.blade.php ENDPATH**/ ?>