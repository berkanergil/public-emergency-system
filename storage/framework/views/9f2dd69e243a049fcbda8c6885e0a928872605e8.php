            ...
            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                <div class="card p-5 shadow p-3 mb-5 bg-white rounded">
                    <div class="card-title  mt-3">
                        <h3 class="create_staff_form text-bold"><?php echo e(__('Create Authority')); ?></h3>
                        <hr class="create_staff_form">
                    </div>
                    <div class="card-body">
                        <form action="<?php echo e(route('createAuthority')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="website"><i class="fas fa-user-tag"></i> <?php echo e(__('Staff Role')); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Tolgahan\Desktop\Tolga\OKUL\YEAR 4\SEMESTER 8\CMSE406\public-emergency-system\resources\views/role_operations/authority_operations/createAuthority.blade.php ENDPATH**/ ?>