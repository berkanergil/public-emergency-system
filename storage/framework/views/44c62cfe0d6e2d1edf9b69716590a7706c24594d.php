            ...
            <table id="notifications" class="table table-hover table-bordered text-center">
                ...
                <tbody class="table-light">
                    <?php $__currentLoopData = $notificationObject->notifications(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><a href="<?php echo e(route('notification', $notification->id)); ?>"><?php echo e($notification->id); ?></a></td>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Tolgahan\Desktop\Tolga\OKUL\YEAR 4\SEMESTER 8\CMSE406\public-emergency-system\resources\views/system_operations/notifications/notifications.blade.php ENDPATH**/ ?>