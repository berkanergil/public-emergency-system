 ...
 <?php $__env->startSection('sweetjs'); ?>
     <script>
         window.array1 = <?php echo $lat_lon_handled; ?>

         window.array2 = <?php echo $lat_lon_being_handled; ?>

         window.array3 = <?php echo $lat_lon_not_handled; ?>

         window.array4 = <?php echo $lat_lon_merged; ?>
