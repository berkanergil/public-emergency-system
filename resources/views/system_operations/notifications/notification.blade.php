            ...
            <div class="col-md-8">
                <div class="card user-card shadow p-3 mb-5 bg-white rounded">
                    <div class="card-header cards text-center">
                        <h5 class=" text-white">{{ __('NOTIFICATION INFORMATION') }}</h5>
                    </div>
                    <div class="card-block p-4">
                        <div class="row">
                            <div class="col-12">
                                <p class="text-bold mt-3"> <span class="text-muted">
                                        {{ __('Notification Title') }}:</span>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <p class="text-bold"> <span class="text-muted">
                                    ...
                                    {{ Str::title($notification->notification) }}
                                </p>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <a href="{{ route('editNotification', $notification->id) }}" class="form-buttons float-right">
