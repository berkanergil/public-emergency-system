                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content border border-dark">
                                                                    ...
                                                                    <div class="modal-body box-profile">
                                                                        <h3
                                                                            class="profile-username text-center text-primary">
                                                                            {{ Str::title($agent->department->title) . ' Department' }}
                                                                        </h3>
                                                                        ...
                                                                        <ul class="list-group list-group-unbordered mb-3">
                                                                            ...
                                                                            <li class="list-group-item border-0">
                                                                                <b>Agent ID:</b> <a
                                                                                    class="float-right">{{                                                                                     class="float-right">$agent->id }}</a>
                                                                            </li>
                                                                            <li class="list-group-item border-0">
                                                                                <b>Name Surname:</b> <a
                                                                            ...
                                                                            <li class="list-group-item border-0">
                                                                                <b>Phone Number:</b> <a
                                                                                    class="float-right">{{                                                                                     class="float-right">$agent->msisdn }}</a>
                                                                            </li>
                                                                            <li class="list-group-item border-0">
                                                                                <b>Email:</b> <a
                                                                                    class="float-right">{{                                                                                     class="float-right">$agent->msisdn }}</a>
                                                                            ...
                                                                            <li class="list-group-item border-0">
                                                                                <b>Device ID:</b> <a
                                                                                    class="float-right">{{                                                                                     class="float-right">$agent->device_id }}</a>
                                                                            </li>
                                                                            <li class="list-group-item border-0">
                                                                                <b>Device Token:</b> <a
                                                                                    class="float-right">{{                                                                                     class="float-right">$agent->device_token }}</a>
                                                                            </li>
