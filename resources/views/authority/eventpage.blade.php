                                ...
                                <div class="card-body">
                                    <ul>
                                        ...
                                        <li class="list-group-item border-0"><strong>Name Surname:</strong>
                                            ...
                                            @else{{ Str::title($event->staff->name . ' ' . $event->staff->surname . ' '
                                            . ' (Staff Category)') }}
                                            @endif
                                        </li>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <h3 class="text-bold mb-3">Agent Group:
                                    @if (isset($group))
                                    <a href="{{ route('one_agentGroup',$group[0]->group_id) }}" class="text-danger">{{ $group[0]->group_id }} (Click To
                                        See
                                        More
                                                ...
                                                <div class="modal-content border border-dark">
                                                    ...
                                                    <div class="modal-body box-profile">
                                                        ...
                                                        <ul class="list-group list-group-unbordered mb-3">
                                                            ...
                                                            <li class="list-group-item border-0">
                                                                <b>Agent ID:</b> <a class="float-right">{{ $agent->id
                                                                    }}</a>
                                                            </li>
                                                            <li class="list-group-item border-0">
                                                                <b>Name Surname:</b> <a class="float-right">{{
                                                                    Str::title($agent->name . ' ' . $agent->surname) }}
                                                                </a>
                                                            </li>
                                                            <li class="list-group-item border-0">
                                                            ...
                                                            <li class="list-group-item border-0">
                                                                <b>Email:</b> <a class="float-right">{{ $agent->msisdn
                                                                    }}</a>
                                                            </li>
                                                            <li class="list-group-item border-0">
                                                                <b>Device ID:</b> <a class="float-right">{{
                                                                    $agent->device_id }}</a>
                                                            </li>
                                                            <li class="list-group-item border-0">
                                                                <b>Device Token:</b> <a class="float-right">{{
                                                                    $agent->device_token }}</a>
                                                            </li>
