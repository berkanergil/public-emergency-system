                                ...
                                <div class="card-body">
                                    <ul>
                                        ...
                                        <li class="list-group-item border-0"><strong>Report Date & Time:</strong>
                                            {{ $event->created_at }}</li>
                                        <li class="list-group-item border-0"><strong>Editor:</strong> Kullanıcı Eklenecek</li>
                                        <li class="list-group-item border-0"><strong>Note:</strong>
                                            {{ $event->note }}</li>
                                    </ul>
                                    <a href="{{ route('edit_report',$event->id) }}" class="btn p-2 float-right btn-dark"><i
                                            class="far fa-edit"></i>
                                        Make Changes</a>
                                </div>
                            </div>
                                ...
                                <div class="modal fade" id="agentModal3" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content border border-dark">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-center text-bold text-dark"
                                                    id="exampleModalLongTitle"><i class="fas fa-id-badge mr-2"></i>Agent
                                                    Details</h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
