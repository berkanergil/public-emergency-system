    ...
    <div class="row card-info card-outline pt-3">
        <div class="row">
            <div class="col-md-6">
                ...
                <h3 class="text-bold mb-3">Agent Group: <span class="text-danger">{{ $group[0]->group_id }}</span></h3>
            </div>
            <div class="col-md-6">
                ...
                <div class="card-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                        <li class="list-group-item">
                            <b>Name Surname:</b> <a class="float-right">{{ Str::title($agent->name . ' ' .
                                $agent->surname) }}</a>
                        </li>
                        <li class="list-group-item">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content border border-dark">
                            <div class="modal-header">
                                <h5 class="modal-title text-center text-bold text-dark" id="exampleModalLongTitle">
                            ...
                            <div class="modal-body box-profile">
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    ...
                                    <li class="list-group-item border-0">
                                        <b>Device Token:</b> <a class="float-right">{{ $agent->device_token }}</a>
                                    </li>
