                ...
                <div class="card-body">
                    <form action="{{ route('editAgent', ['id' => $staff->id]) }}" method="POST">
                        ...
                        <div class="row gutters">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="name"><i class="far fa-id-card pr-1"></i>{{ __('First Name') }}</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="name"><i class="far fa-building"></i> {{ __('Department') }}</label>
